...
<>
        ...
        <h3> To get you off on the right foot, we've made this little tutorial to make sure everything is set up correctly.</h3>
        ...
        <p> Now that you've made and seen your blank farm, let's develop it. We'll do this by creating your first task. Click below to open up your tasks page in a new tab. Type in "Create my First Task" in the "New Task Box", and then click the "+" button. Then, you'll see it below. Click the "Submit" button on the task to mark it as complete. Then close that page and come back here.</p>
        <p className = "buttonP"><a className = "TutorialLinkB" href = "/tasks" target = "_blank" rel="noopener noreferrer">Make Your First Task</a></p>
        <p> Now that you've completed a task, your farm has developed! Click the button you pressed earlier to create your farm to see your newly-developed plot. Come back one more time when you've realized the beauty of the journey ahead.</p>
